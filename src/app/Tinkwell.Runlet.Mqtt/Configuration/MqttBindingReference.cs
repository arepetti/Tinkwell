...
/// the <c>on</c>-level <see cref="MqttVerbBlock.WhenExpression"/>.
/// </param>
...
/// Overrides the parent <see cref="MqttVerbBlock.OnError"/> when set.
/// </param>
public sealed record MqttBindingReference(
    string BindingName,
    string? AssemblyName,
